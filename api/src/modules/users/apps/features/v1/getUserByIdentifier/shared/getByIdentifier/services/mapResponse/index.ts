...
export  interface IGetUserByIdentifierResponseMapService extends IServiceHandlerAsync<UserEntity,GetUserByIdentifierResponseDto>{}

@sealed
@Service()
export class GetUserByIdentifierResponseMapService implements IGetUserByIdentifierResponseMapService {
  public handleAsync(params: UserEntity): Promise<Result<GetUserByIdentifierResponseDto, ResultError>> {
