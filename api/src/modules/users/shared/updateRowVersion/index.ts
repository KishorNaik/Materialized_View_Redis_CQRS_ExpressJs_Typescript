import { Container, ExceptionsWrapper, GuardWrapper, IServiceHandlerVoidAsync, Result, ResultError, ResultFactory, sealed, Service, StatusEnum, VOID_RESULT, VoidResult } from "@kishornaik/utils";
...
export class UpdateUserRowVersionService implements IUpdateUserRowVersionService {
  ...
  public handleAsync(params: IUpdateUserRowVersionServiceParameters): Promise<Result<VoidResult, ResultError>> {
