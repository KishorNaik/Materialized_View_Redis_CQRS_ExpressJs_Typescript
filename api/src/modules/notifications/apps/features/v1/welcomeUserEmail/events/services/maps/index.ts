...
export interface IWelcomeUserEmailMapService
	extends IServiceHandlerAsync<JsonString, WelcomeUserEmailIntegrationEventRequestDto> {}
...
export class WelcomeUserEmailMapService implements IWelcomeUserEmailMapService {
	public handleAsync(
		params: JsonString
	): Promise<Result<WelcomeUserEmailIntegrationEventRequestDto, ResultError>> {
