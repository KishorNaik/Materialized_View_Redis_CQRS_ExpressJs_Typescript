...
export class Init1753178874629 implements MigrationInterface {
    name = 'Init1753178874629'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_e2a77b8eb9c6bfefe540b1eaec" ON "user"."usersCredentials" ("userName") `);
        await queryRunner.query(`CREATE TYPE "users"."usersKeys_status_enum" AS ENUM('1', '0')`);
        await queryRunner.query(`CREATE TABLE "users"."usersKeys" ("id" BIGSERIAL NOT NULL, "identifier" character varying(50) NOT NULL, "status" "users"."usersKeys_status_enum" NOT NULL DEFAULT '0', "created_date" TIMESTAMP(6) NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "modified_date" TIMESTAMP(6) NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "version" integer NOT NULL, "refreshToken" text NOT NULL, "refreshTokenExpiresAt" date NOT NULL, "aesSecretKey" text, "hmacSecretKey" text, "userId" character varying NOT NULL, CONSTRAINT "UQ_8e0e067c9d31721764df95af145" UNIQUE ("aesSecretKey"), CONSTRAINT "UQ_ff4a3f71fc7b256a76b085c8418" UNIQUE ("hmacSecretKey"), CONSTRAINT "REL_8dad5622e2872163359b06dcb3" UNIQUE ("userId"), CONSTRAINT "PK_f83524e6dcdd085a19437309a1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_188994adc77d065ac1572452d6" ON "users"."usersKeys" ("identifier") `);
        ...
        await queryRunner.query(`ALTER TABLE "users"."usersKeys" ADD CONSTRAINT "FK_8dad5622e2872163359b06dcb32" FOREIGN KEY ("userId") REFERENCES "user"."users"("identifier") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users"."usersKeys" DROP CONSTRAINT "FK_8dad5622e2872163359b06dcb32"`);
        ...
        await queryRunner.query(`DROP INDEX "users"."IDX_188994adc77d065ac1572452d6"`);
        await queryRunner.query(`DROP TABLE "users"."usersKeys"`);
        await queryRunner.query(`DROP TYPE "users"."usersKeys_status_enum"`);
        await queryRunner.query(`DROP INDEX "user"."IDX_e2a77b8eb9c6bfefe540b1eaec"`);
